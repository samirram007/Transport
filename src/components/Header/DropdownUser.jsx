...
const DropdownUser = () => {
  ...
  if (userProfile.isFetching) {
    return <Loader className='animate-spin text-6xl'/>
  }
    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">{userProfile.data?.data?.role} </span>
        </span>

        <span className="h-12 w-12 rounded-full overflow-clip bg-meta-2 dark:bg-meta-4">
