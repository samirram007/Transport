...
import SchoolContextProvider from '../context/EducationBoardContextProvider';
import { useEducationBoards } from '../hooks/queries';
...
export default function FilterTable({ columns, pageSize = 100,
    ...
    const fetchedData = useEducationBoards()
            ...
            <div className='row   flex flex-col md:flex-row justify-between gap-2    '>
                ...
                <div className='grid grid-cols-9 w-full gap-2  '>
                    <div className="col-span-9 md:col-span-2 ">
                        ...
                        <Breadcrumb pageName="education boards" parentName="Settings" type={"box"} />
                    </div>
