...
import { useIncomeGroupContext } from '../context/features/useIncomeGroupContext';
import EntryForm from './EntryForm';



const Delete = ( ) => {
  const { action,setAction, isModalOpen, setModalOpen } = useIncomeGroupContext();
