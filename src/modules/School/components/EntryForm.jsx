...
import { SchoolTypeSelect } from '@/modules/GlobalData/components/Selector/SchoolTypeSelect';
import { useSchoolContext } from '../context/features/useSchoolContext';
...
const EntryForm = () => {
    const { selectedSchool: data, action } = useSchoolContext()
            ...
            <form onSubmit={formik.handleSubmit} className="flex flex-col h-full ">
                ...
                <div   className="flex-1 overflow-y-auto grid grid-rows-auto gap-4">
                    <div className=" flex flex-col gap-8 max-h-80 w-6/12 mx-auto">
                        ...
                        <EducationBoardSelect formik={formik} name="educationBoardId" label="Education Board" />
                        <SchoolTypeSelect formik={formik} name="schoolTypeId" label="School Type" />
