...
import { ExpenseGroupSelect } from '@/modules/GlobalData/components/Selector/ExpenseGroupSelect';
...
const EntryForm = () => {
    const { selectedExpenseHead: data, action } = useExpenseHeadContext()
...
const FormikForm = () => {
    ...
    const { selectedExpenseHead: initialValues,
        entryMode, action,
        handleMutation, setModalOpen } = useExpenseHeadContext()
            ...
            <form onSubmit={formik.handleSubmit} className="flex flex-col h-full ">
                ...
                <div className="flex-1 overflow-y-auto grid grid-rows-auto gap-4">
                    <div className=" flex flex-col gap-8 max-h-80 w-6/12 mx-auto">
                        ...
                        <ExpenseGroupSelect formik={formik} />
