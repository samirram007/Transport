...
import { SchoolTypeContextProvider } from '../context/SchoolTypeContextProvider';
import { useSchoolTypes } from '../hooks/queries';
...
export default function FilterTable({ columns, pageSize = 100,
    ...
    const fetchedData = useSchoolTypes()
