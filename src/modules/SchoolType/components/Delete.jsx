...
import { useSchoolTypeContext } from '../context/features/useSchoolTypeContext';
import EntryForm from './EntryForm';



const Delete = ( ) => {
  const { action,setAction, isModalOpen, setModalOpen } = useSchoolTypeContext();
