...
export default function FilterTable({ columns, pageSize = 100,
    ...
    const { fetchedData, dataDisplay } = useFeeDataContext()

    const [sorting, setSorting] = useState([{ id: 'feeNo', desc: true }])
        ...
        <>
            <div className='flex flex-col justify-between gap-2 row md:flex-row '>
                ...
                <div className=' grid grid-cols-1 md:grid-cols-[350px_1fr] w-full gap-2  '>
                    <div className="">
                        <Breadcrumb pageName="fees" parentName="Settings" type={"box"} />
                    </div>
...
const CollectionButton = () => {
    ...
    return (
        <Link to={`/${userProfile.data?.data?.role}/fees/collection`} title='Create new'
            className="  ">
        ...
        <div className="py-6   ">
            ...
            >
                <div className='md:w-full'>
                    ...
                    <div className='grid  grid-cols-[100px_100px_200px_200px_200px_1fr_1fr] gap-1   font-bold border-b-4 bg-slate-500/50 rounded-md pl-2'>
                ...
                {table.getRowModel().rows.map((row, i) => (
                    <div key={i} className='md:w-full'>
                        ...
                        {row.getVisibleCells().map(cell => (
                            ...
                            <div key={cell.id} className={`grid  grid-cols-[100px_100px_200px_200px_200px_1fr_1fr]  border-2 gap-1 `} >
