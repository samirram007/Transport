...
import { useDesignationContext } from '../context/features/useDesignationContext';
import EntryForm from './EntryForm';



const Delete = ( ) => {
  const { action,setAction, isModalOpen, setModalOpen } = useDesignationContext();
  ...
  return (
    ...
    <Button onClick={handleOnClick}
        ...
        <RiDeleteBin7Line   className='text-3xl text-teal-600 cursor-pointer
