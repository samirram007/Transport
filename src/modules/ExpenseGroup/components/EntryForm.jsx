...
const EntryForm = () => {
    const { selectedExpenseGroup: data, action } = useExpenseGroupContext()
...
const FormikForm = () => {
    ...
    const { selectedExpenseGroup: initialValues,
        entryMode, action,
        handleMutation, setModalOpen } = useExpenseGroupContext()
